...
<div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'GraphRAG short-term and long-term memory is updating live' : 'Updating in real time...' }}
        </div>
<div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">A small amount of content is still being processed. Refresh the graph again shortly.</span>
