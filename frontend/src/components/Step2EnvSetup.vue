...
<div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Generating agent profiles</span>
          </div>
          <div class="step-status">
...
<div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Generating simulation configuration</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on the simulation requirement and real-world seed, the LLM intelligently configures time flow, recommendation algorithms, each individual agent's active windows, posting frequency, event triggers, and related parameters.
          </p>
...
<div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Hourly Active Agents</span>
...
<div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Initial Activation Scheduling</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Automatically generate initial activation events and hot topics from the narrative direction to shape the starting state of the simulated world
          </p>
...
<div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFishES automatically plans and simulates <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span>  hours of real time, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed real-world time</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>At an agent count of 100, estimated runtime is about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        At an agent count of 100, estimated runtime is {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
...
<div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Lessons learned and action-style preferences</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Distinctive Memory Imprint</span>
                <span class="dim-desc">Memory formed from the real-world seed</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Social Relationship Network</span>
                <span class="dim-desc">Personal links and interaction graph</span>
              </div>
            </div>
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generating agent profiles' || newStage === 'generating_profiles') {
    ...
    phase.value = 2
    if (!configTimer) {
      addLog('Starting simulation configuration generation...')
      startConfigPolling()
    }
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time configuration: ${tc.minutes_per_round} min per round, total ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)} rounds`)
        }
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog('Configuration generation in progress. Starting polling...')
        startConfigPolling()
      }
    }
  } catch (err) {
