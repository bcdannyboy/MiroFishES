    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the documents and simulation requirements, extracts real-world seeds, and generates an appropriate ontology structure automatically.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks the documents and calls Zep to build a knowledge graph, extract entities and relationships, and produce temporal memory and community summaries.
          </p>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert('Failed to create the simulation: ' + (res.error || 'Unknown error'))
    }
  } catch (err) {
