...
<nav class="navbar">
      <div class="nav-brand" @click="goHome">MiroFishES</div>
...
<div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph construction will start automatically once ontology generation is complete.</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After the documents are uploaded, the LLM analyzes the content and automatically generates an ontology structure suitable for public-opinion simulation (entity types + relationship types).
                </div>
              </div>
...
<div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Using the generated ontology, the documents are chunked and sent to the Zep API to build a knowledge graph and extract entities and relationships.
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files were found. Return to the home page and try again.'
    loading.value = false
    return
  }
