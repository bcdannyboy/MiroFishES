      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/MiroFish_logo_left.jpeg" alt="MiroFishES Logo" class="hero-logo" />
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe the simulation or forecasting request in natural language"
                  rows="6"
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">Engine: MiroFishES-V1.0</div>
              </div>
            </div>
...
// Start the simulation flow immediately; the API call happens on the Process page
const startSimulation = () => {
  if (!canSubmit.value || loading.value) return
  
  // Store the pending upload payload
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    setPendingUpload(files.value, formData.value.simulationRequirement)
    
    // Jump to the Process page immediately using the special "new" marker
    router.push({
      name: 'Process',
