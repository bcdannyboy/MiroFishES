"""Graph-native query tools built on the cutover query services."""
...
logger = get_logger('mirofish.graph_query_tools')
    ...
    def panorama_search(
        ...
        for edge in all_edges:
            ...
            is_historical = (
                edge.is_expired
                or edge.is_invalid
                or bool(edge_attributes.get("history_kind") == "runtime_transition")
            )
