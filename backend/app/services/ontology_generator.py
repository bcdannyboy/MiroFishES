...
"""
    ...
    def _normalize_entity_name(cls, value: Any, fallback: str) -> str:
        """Convert an entity name to the PascalCase format required by the graph schema."""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Keep ontology size bounded so downstream graph compilation stays deterministic.
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
