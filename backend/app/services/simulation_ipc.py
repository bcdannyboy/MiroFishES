...
2. The simulation script polls the directory, executes commands, and writes responses into `responses/`
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Optional target platform
                ...
                - None: Use both platforms in dual-platform simulations, or the active platform in single-platform runs
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform, overridden by an interview item's `platform`
    ...
    def check_env_alive(self) -> bool:
        ...
        This is determined by inspecting the `env_status.json` file.
        """
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        ...
        # Read command files in timestamp order
        command_files = []
