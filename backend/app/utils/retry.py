...
Used for external API invocations such as LLM requests.
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Process a batch and retry each failed item individually.
        
        Args:
            items: Items to process
            process_func: Handler that receives a single item
            exceptions: Exception types that should trigger retries
