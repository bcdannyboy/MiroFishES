"""
Check whether generated profile formats satisfy OASIS expectations.
Validation coverage:
...
def test_profile_formats():
    """Test the generated profile formats."""
    print("=" * 60)
...
def show_expected_formats():
    ...
    print("\n" + "=" * 60)
    print("Reference for the profile formats expected by OASIS")
    print("=" * 60)
